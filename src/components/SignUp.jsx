...
function UserRegistration() {
    ...
    const successRegister = useSelector(state => state.user.success);
        ...
        <>
            {successRegister ? (
                <div>
                    ...
                    <p>Um e-mail será enviado para: {emailSend}.</p>
                </div>
            ) : (
                <div className="cadastro-container">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {!passwordMatch && <p className="password-match">As senhas não são iguais</p>}
